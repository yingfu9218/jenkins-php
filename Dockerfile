...
USER root
RUN apt-get update && apt-get install -y php  curl php-pear php-xdebug nodejs ant rsync vim ansible
...
RUN echo "export PATH=$PATH:/home/jenkins/.composer/vendor/bin" >> $JENKINS_HOME/.bashrc 
